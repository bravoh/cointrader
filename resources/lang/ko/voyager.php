...
return [
    ...
    'generic' => [
        ...
        'all_done'               => '모두 종료',
        'are_you_sure'           => '동의합니까',
        'are_you_sure_delete'    => '삭제 하시겠습니까?',
        'auto_increment'         => '자동 증가',
        'browse'                 => '브라우저',
        'builder'                => '빌더',
        'bulk_delete'            => '대량 삭제',
        'bulk_delete_confirm'    => '네, 삭제하겠습니다.',
        ...
        'delete_question'        => '이것을 정말로 삭제하시겠습니까?',
        'delete_this_confirm'    => '네, 이것을 삭제하겠습니다.',
        'deselect_all'           => '모두 삭제',
        'download'               => '다운로드',
        'edit'                   => '설정',
        'email'                  => '이메일',
        'error_deleting'         => '죄송합니다. 다시 삭제를 시도해주세요.',
        'exception'              => '예외',
        'featured'               => '특징',
        ...
        'internal_error'         => '내부오류',
        'items'                  => '아이템',
        'keep_sidebar_open'      => '슬라이드바를 오픈하세요.',
        'key'                    => '키',
        'last_modified'          => '마지막으로 수정힌 날짜',
        'length'                 => '길이',
        'login'                  => '로그인',
        'media'                  => '미디아',
        'menu_builder'           => '메뉴 빌더',
        ...
        'rename'                 => '이름 바꾸기',
        'required'               => '필수',
        'return_to_list'         => '목록으로 되돌아가기',
        'route'                  => '경로',
        'save'                   => '저장',
        'search'                 => '검색',
        'select_all'             => '모두 선택하기',
        'select_group'           => '기존 그룹 선택 또는 새로 추가',
        'settings'               => '설정',
        'showing_entries'        => 'Showing :from to :to of :all entry|Showing :from to :to of :all entries',
        'submit'                 => '제출',
        'successfully_added_new' => '신규 추가 완료',
        'successfully_deleted'   => '삭제 완료',
        'successfully_updated'   => '업데이트 완료',
        'timestamp'              => '타임스탬프',
        'title'                  => '제목',
        'type'                   => '타입',
        'unsigned'               => '서명되지 않음',
        'unstick_sidebar'        => '사이드바를 풉니다.',
        'update'                 => '업데이트',
