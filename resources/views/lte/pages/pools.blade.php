...
<div class="ui pointing secondary menu" style="border-bottom: unset;">
    <a class="m item active" href="{{ makeUrl('mining-pools') }}" style="background: #ddd; border-radius: 2px;margin-right: 5px;">
        <i class="file alternate icon"></i>@lang('v7.MINING_POOLS')
    </a>
    <a class="m item" href="{{ makeUrl('mining-pools') }}/hashrate-distribution" style="background: #ddd; border-radius: 2px;">
...
<div class="tab ui active">
    <div class="box box-success table-heading-class">
        <div class="box-header with-border">
            <h3 class="box-title">@lang('v7.MINING_POOLS')</h3>
            <h1 class="sr-only">@lang('v7.MINING_POOLS')</h1>
        ...
        <p style="padding: 10px;">@lang('v7.MINING_POOLS_DESC')</p>
    </div>
    <div class="row">
