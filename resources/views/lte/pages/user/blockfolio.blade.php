...
function updateFiat(profit_loss, quantity, pair, exchange)
{
  var data = {
    ...
    pair : pair,
    quantity: quantity,
    fiat_currency: $('.top-currency-dropdown .item a.selected').attr('value')
  };
  $.getJSON(APP_URL + '/ajax-get-pair-price', data, function(result) {
    ...
    $('.profit_loss_fiat_' + exchange + '_' + pair).html($('.top-currency-dropdown .item a.selected').attr('id') + result).addClass(class_name);
  });
}
        ...
        <div class="panel panel-default">
            <div class="box box-success table-heading-class">
                  <div class="box-header with-border">
                      <h3 class="box-title"> @lang('user.BLOCKFOLIO_PAGE_HEADING') </h3>
