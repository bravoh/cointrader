...
<div class="box box-success table-heading-class">
    <div class="box-header with-border">
        <h3 class="box-title">@lang('v7.ADVETISE_TITLE')</h3>
        <h1 class="sr-only">@lang('v7.ADVETISE_TITLE')</h1>
    </div>
</div><br />
     ...
     <div class="col-md-13">
        <div>
         <div class="single_post_content">
          ...
          <ul class="spost_nav single-page-news" style="list-style: none;padding: 10px;margin-top:-18px;background: white;">
