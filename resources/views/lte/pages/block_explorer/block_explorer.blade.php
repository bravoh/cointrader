...
@section('styles')
<style type="text/css">.block-explorer-tbl th{background-color: #2c3b41 !important;}.search-btn{width: 150px;}</style>
@stop
@section('scripts')
        ...
        <div class="panel panel-default">
            <div class="box box-success table-heading-class">
                <div class="box-header with-border">
                    <h3 class="box-title">@lang('blockexplorer.BLOCK_EXPLORER_HEADING')</h3>
                </div>
            </div>
            @include(getCurrentTemplate() . '.pages.block_explorer.block_search')
            <div class="panel-body form-section">
                <h2>@lang('blockexplorer.LATEST_BLOCK_INFO_HEADING')</h2>
