...
<style type="text/css">
.bsbig_fig > a img {min-height: 313px !important;}
.news-page-video iframe{ text-align: center;width: 100%; height: 272px; }
@media only screen and (min-width: 1650px)  {
.news-wrapper {width: 80%; margin: 0 auto;}
}
@media only screen and (max-width: 1650px)  {
.news-wrapper {width: 100%; margin: 0 auto;}
}
.news-search-input{width: 75%;float: left;margin-right: 5px;height: 32.48px;}
</style>
@stop
@section('scripts') 
        ...
        <aside class="right_content">
          ...
          <div class="single_sidebar wow fadeInDown">
            ...
            <ul style="background-color: white; padding: 10px;">
              <li><a href="{{ makeUrl('archive-news') }}">@lang('menu.ARCHIVE_NEWS')</a></li>
              <li><a href="{{ makeUrl('live-crypto-currencies-updates') }}">@lang('menu.COINS_LIVE_WATCH')</a></li>
              <li><a href="{{ makeUrl('cryptocurrency-converter') }}">@lang('menu.CONVERTER')</a></li>
              <li><a href="{{ makeUrl('cryptocurrency-widgets') }}">@lang('menu.WIDGETS')</a></li>
