...
<style type="text/css">.bsbig_fig > a img {min-height: 313px !important;}.news-page-video iframe{ text-align: center;width: 100%; height: 272px; }@media only screen and (min-width: 1650px)  {.news-wrapper {width: 70%; margin: 0 auto;}}@media only screen and (max-width: 1650px)  {.news-wrapper {width: 100%; margin: 0 auto;}}.h1, .h2, .h3, h1, h2, h3 {margin-top: unset;margin: unset;padding: unset;}.box-header {background-color: #337ab7;padding: 10px;color: white;}.box-header h3 {font-size: 18px;}a {text-decoration: none !important;}.news-search-input{width: 75%;float: left;margin-right: 5px;height: 32.48px;}</style>
@stop
@section('scripts') 
...
<div class="news-wrapper">
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="latest_post">
        <div class="latest_post_container" style="padding: unset; height: unset;">
            ...
            <li style="margin-bottom: 10px;">
              <div class="media"> 
                ...
                <div class="media-body"> 
                  ...
                  <i class="fa fa-clock-o fa-fw" style="font-size: 1em;"></i>{{ date("Y-m-d", $news['publishedAt']) }}
                </div>
              </div>
            </li>
            @endforeach
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="single_post_content" style="background-color: white;margin-top: 10px;">
          <div class="box box-success table-heading-class" style="box-shadow: unset;">
              <div class="box-header with-border">
                  <h3 class="box-title">@lang('headings.MOST_READ_NEWS')</h3>
              </div>
          </div>
          <div class="single_post_content_left" style="padding: 10px;">
          ...
          <div class="single_post_content_right" style="padding: 10px;">
            <ul class="spost_nav">
      ...
      <div class="col-md-8">
        <div class="left_content">
          <div class="fashion_technology_area" style="margin-bottom: 20px;">
            ...
            <div class="technology" style="background-color: white;">
              <div class="single_post_content">
                <div class="box box-success table-heading-class" style="box-shadow: unset;">
                    <div class="box-header with-border">
      ...
      <div class="col-md-4">
        <aside class="right_content">
          <div class="single_sidebar">
            ...
            <div class="latest_post_container" style="padding: 10px; background-color: #fff;height: 560px;">
              <ul class="spost_nav">
                ...
                <li>
                  <div class="media wow fadeInDown"> 
                    ...
                    <div class="media-body"> 
                      ...
                      <i class="fa fa-clock-o fa-fw" style="font-size: 1em;"></i>{{ date("Y-m-d H:i:s", $news['publishedAt']) }}
                    </div>
                  </div>
                  <hr />
                </li>
          ...
          <div class="single_sidebar">
            ...
            <div class="latest_post_container" style="padding: 10px; background-color: #fff;height: 337px;">
              <ul class="spost_nav">
          ...
          <div class="single_sidebar wow fadeInDown">
            ...
            <ul style="padding: 10px;">
              <li style="padding: 2px;"><a href="{{ makeUrl('archive-news') }}">@lang('menu.ARCHIVE_NEWS')</a></li>
              <li style="padding: 2px;"><a href="{{ makeUrl('live-crypto-currencies-updates') }}">@lang('menu.COINS_LIVE_WATCH')</a></li>
              <li style="padding: 2px;"><a href="{{ makeUrl('cryptocurrency-converter') }}">@lang('menu.CONVERTER')</a></li>
              <li style="padding: 2px;"><a href="{{ makeUrl('cryptocurrency-widgets') }}">@lang('menu.WIDGETS')</a></li>
              <li style="padding: 2px;"><a href="{{ URL::to('sitemap') }}.xml">Sitemap</a></li>
            </ul>
          </div>
        </aside>
      </div>
