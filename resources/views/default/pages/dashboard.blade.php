...
<link href="{{ URL::asset('public/css/slick/slick.css') }}"" rel="stylesheet">
<link href="{{ URL::asset('public/css/slick/slick-theme.css') }}"" rel="stylesheet">
...
.news-wrapper {width: 70%; margin: 0 auto;}
}
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-xs-4">
                        <i class="fa fa-usd fa-4x"></i><i class="fa fa-usd fa-2x" style="inline"></i>
                    </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-bar-chart-o fa-fw"></i> @lang('headings.TOP_10')
            </div>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody class="crypto-currencies-data">
                                    ...
                                    <tr id="TABLE_ROW_{{$market->symbol}}">
                                        ...
                                        <td class="percent_change_day right" id="CHANGE24HOURPCT_{{$market->symbol}}" style="color: @if($market->percent_change_day >= 0) green @else red @endif">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-newspaper-o fa-fw"></i> @lang('headings.LATEST_NEWS')
            </div>
            <div class="panel-body">
    ...
    <div class="col-lg-4">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-cogs fa-fw"></i> @lang('headings.TRADING_PAIRS')
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-pie-chart fa-fw"></i> @lang('headings.DOMINANCE_DONUT')
            </div>
            <div class="panel-body">
        ...
        <div class="chat-panel panel panel-default">
            ...
            <div class="panel-body form-section" style="min-height: 585px;">
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <i class="fa fa-bullhorn fa-fw"></i> @lang('headings.ACTIVE_ICOS')
            </div>
                    ...
                    @foreach($icos as $ico)
                        <div class="dashboard-active-icos">
                            <a href="{{ makeUrl('crypto-ico') }}/{{ $ico->alias }}" title="{{ $ico->name }}">
                                ...
                                <img class="image" alt="{{ $ico->name }} ico" title="{{ $ico->name }} ico" src="{{URL::asset('public/storage/' . $ico->image)}}" height="30">
                                @else
