...
h1 {font-size: 15px;}
.ui.button{    width: 100%;border: 1px solid #ddd;background: #fff;}
</style>
@stop
@section('content')
<div class="container">
                    ...
                    <div class="panel-body cct-form-btn form-section">
                        ...
                        <form role="form" method="post" accept="{{ makeUrl('user/register') }}">
                            ...
                            <fieldset>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input name="newsletter" type="checkbox" value="1">@lang('user.SUBSCRIBE_NEWSLETTER')
                                    </label>
                                </div>
            ...
            <div class="col-md-6">
                <div class="login-panel panel panel-default">
                    <div class="panel-body cct-form-btn form-section">
                        ...
                        <fieldset>
                            <div class="form-group">
                                <a href="{{ makeUrl('user/login/facebook') }}" class="ui button latest-block-btn">
                                    <i class="fa fa-facebook"></i> Register with Facebook
                                </a>
                            </div>
                            <div class="form-group">
                                <a href="{{ makeUrl('user/login/twitter') }}" class="ui button latest-block-btn">
