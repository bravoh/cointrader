    ...
    <div class="ui floating dropdown labeled icon button">
        ...
        <div class="menu" style="z-index:99999999">
            <div class="ui icon search input">
                <input type="text" placeholder="@lang('menu.SEARCH')..."></div>
            <div class="scrolling menu top-currency-dropdown">
                ...
                @if(isset($_COOKIE['SELECTED_CURRENCY']))
                    ...
                    @if($_COOKIE['SELECTED_CURRENCY'] === 'USD')
                        ...
                        <div class="item selected" value="1" id="$" rel="USD">
                            <i class="us flag"></i>
                            USD
                        </div>
                    @else
                        <div class="item" value="1" id="$" rel="USD">
