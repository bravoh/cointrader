...
<meta name="keywords" content="@yield('meta_keyw')">
...
<link href="{{ URL::asset('public/lct/css/default_template.css') }}" rel="stylesheet" />
<link href="{{ URL::asset('public/css/font-awesome/css/font-awesome.min.css') }}" rel="stylesheet" />
<link id="color-scheme-css" gel="new" href="{{ URL::asset('public/lct/css/color_schemes') }}/{{{ $_COOKIE['THEME_COLOR'] or 'default' }}}.css" rel="stylesheet" />
