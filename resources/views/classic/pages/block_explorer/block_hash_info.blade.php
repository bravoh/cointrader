    ...
    <div class="col-md-12">
        ...
        <div class="panel-body">
		    ...
		    <div class="table-responsive">
		        <table class="table table-bordered table-hover block-explorer-tbl" style="background: white;">
		            <tbody>
		            	<tr>
		    ...
		    <div class="table-responsive">
		        <table style="width: 100%;background: white;" class="table dataTable no-footer dtr-inline collapsed" id="dataTables-example">
		        	<thead>
		        		<tr>
