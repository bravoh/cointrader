...
@section('content')
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="login-panel panel panel-default">
                <div class="panel-heading">
                    ...
                    <h1>@lang('headings.CRYPTO_CONVERTER')</h1>
                </div>
    ...
    <div class="ui segment descript">
        <div class="ui teal large ribbon label"><strong>How it Works?</strong></div>
        <p style="margin-top:15px">
            <strong>{{ setting('site.site_name') }}</strong> @lang('v6.CONVERTER_DESC_1')
        </p>
        <p>
            @lang('v6.CONVERTER_DESC_2') <strong>{{ env('SITE_URL') }}</strong>
        </p>
    </div>
@stop
